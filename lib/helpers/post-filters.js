...
module.exports = (params, cb) => {
  return err => {
    ...
    if (typeof params.source === 'object') {
      ...
      params.source = params.chunks[`${params.name}.${params.extension}`].source;
      params.sourceMap = params.chunks[`${params.name}.${params.extension}`].sourceMap;

      delete params.chunks[params.filename];
    }
