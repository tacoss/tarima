...
module.exports = function render(params, done) {
  ...
  const knownExtensions = ['es', 'esm', 'cjs', 'umd', 'iife', 'test', 'spec', 'min', 'bundle'];
  ...
  return pipeline
    ...
    .then(() => {
      ...
      if (params.extension === 'min') params.data.$minify = true;
      if (params.extension === 'bundle') params.data.$bundle = true;
      if (params.extension === 'es' || params.extension === 'esm') params.data.$format = 'es';
      if (params.extension === 'umd' || params.extension === 'cjs' || params.extension === 'iife') params.data.$format = params.extension;
