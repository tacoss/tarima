    ...
    plugins: [{
      ...
      load: function(id) {
        ...
        return new Promise(function(resolve, reject) {
          ...
          // here is like "fire your parent and such, recursively"
          // this means each dep will notify its own parent
          // may be iterating each one, find its first ancestor (entry-point)
          // and create the reference index (or whatever like that...)
          // console.log();
          // console.log(id, partial.deps);
