...
module.exports = function(options, params, done) {
  Rollup = Rollup || require(moduleResolve('rollup'));
  ...
  Rollup.rollup({
    ...
    plugins: loadPlugins(rollupOptions.plugins || [], rollupOptions).map(function(plugin) {
      ...
      load: function(id) {
        ...
        return new Promise(function(resolve, reject) {
          var _entry = options.cache[path.relative(options.cwd, id)] || {};

          if (_cache[id] && !_entry.dirty) {
