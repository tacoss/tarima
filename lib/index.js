...
var map = require('./helpers/map'),
    ...
    parseFrontMatter = require('./helpers/front-matter');
...
module.exports = {
  ...
  support: {
    getExtensions: function() {
      return Object.keys(support.exts);
    },
    getRuntime: function(ext) {
      return support.exts[ext].included;
    },
    isSupported: function(filename) {
      return support.reSupported.test(filename);
    },
    isTemplate: function(ext) {
      return support.types['template'].indexOf(ext) > -1;
    },
    isScript: function(ext) {
      return support.types['script'].indexOf(ext) > -1;
    }
  }
};
