...
module.exports = (options, params, done) => {
  ...
  if (options.sourceMaps || options.compileDebug) {
  ...
  webpackOptions.externals = merge({}, webpackOptions.externals, params.data.$external, options.external);

  webpackOptions.output = {
    library: bundleName,
    libraryTarget: params.data.$format || webpackOptions.format || 'var',
  };
