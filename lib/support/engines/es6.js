...
function compile(params) {
  if (!params.next) {
    var compiler = params.options['es6-compiler'] || (params.options.traceur ? 'traceur' : params.options.babel ? 'babel' : 'buble');
    var opts = merge({}, typeof params.options[compiler] === 'object' ? params.options[compiler] : {});
